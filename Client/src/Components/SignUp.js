...
function SignUp(){
    ...
    async function handleSubmit(e){
        ...
        try {
            const response = await fetch('https://print-easy.onrender.com/users/sign-up', {
              method: 'POST',
              headers: {
            ...
            <main className="sign-up">
                ...
                <form method="post" onSubmit={(e)=>{handleSubmit(e)}} className="sign-form">
                    ...
                    <div className="pass-div">
                      ...
                      <img onClick={()=>{passVisibility(0)}} className="password-eye" src="https://cdn-icons-png.flaticon.com/128/9458/9458496.png" />
                    </div>
                    <div className="pass-div">
                      <input onChange={(e)=>{setConfirmPassword(e.target.value)}} value={confirmPassword} type="password" placeholder="confirm password"/>
                      <img onClick={()=>{passVisibility(1)}} className="password-eye" src="https://cdn-icons-png.flaticon.com/128/9458/9458496.png" />
                    </div>
