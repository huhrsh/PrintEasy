...
function BusinessSignIn(){
    ...
    async function handleSubmit(e){
        ...
        try {
            const response = await fetch('http://localhost:5000/shop/sign-in', {
              method: 'POST',
              headers: {
            ...
            <main className="sign-in">
                ...
                <form method="post" onSubmit={(e)=>{handleSubmit(e)}} className="sign-form">
                    ...
                    <div className="pass-div">
                      ...
                      <img onClick={()=>{passVisibility()}} className="password-eye" src="https://cdn-icons-png.flaticon.com/128/9458/9458496.png" />
                    </div>
